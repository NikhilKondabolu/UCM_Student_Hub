...
<head>
    ...
    if (pickup && dropoff) {
        ...
        let price1 = price; // Initialize price1 with the original price

        // Apply discount if coupon is valid
        if (coupon === "STUDENT10") {
            price1 = price * 0.90; // 10% discount
        } else if (coupon !== '') {
            alert("Invalid Coupon");
        }

        document.getElementById('distance').innerText = `Distance: ${distance.toFixed(2)} Miles`;
        document.getElementById('price').value = price1.toFixed(2);

        // Display price before discount if a valid coupon is applied
        if (coupon === "STUDENT10") {
            document.getElementById('priceb').innerText = `Price before discount: $${price.toFixed(0)}`;
        } else {
            document.getElementById('priceb').innerText = ''; // Clear the previous price before discount text
        }
        ...
        document.getElementById('provide_ride_button').style.display = 'block';
    } else {
        ...
        document.getElementById('provide_ride_button').style.display = 'none';
    }
}
...
<body>
    ...
    <center>
        <h2>Provide a Ride</h2>
    </center>
    <center>
        <form method="post" action="providerides.php">
            ...
            <div id="provide_ride_button" style="display: none;">
                <input type="submit" name="provide_ride" value="provide Ride">
            </div>
        </form>
    </center>
    <footer>
